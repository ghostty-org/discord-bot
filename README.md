...
* If you have an equivalent of the on-topic channels like `#development`, they
  **should** be added to the serious channel list.
You should probably leave a channel or two off the serious channel list, should
you want to modify any of the fun features above.
