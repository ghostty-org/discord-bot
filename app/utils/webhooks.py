...
class SplitSubtext:
    def __init__(self, message: discord.WebhookMessage) -> None:
        # NOTE: the parameter is a discord.WebhookMessage to force the caller
